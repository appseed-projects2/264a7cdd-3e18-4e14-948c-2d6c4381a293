...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-22 16:04`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/264a7cdd-3e18-4e14-948c-2d6c4381a293.git
$ cd 264a7cdd-3e18-4e14-948c-2d6c4381a293
```
